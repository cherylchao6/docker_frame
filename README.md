...
- 讓別人部署我的 server 步驟不夠簡易： 這也是苦惱了我很久，儘管有 docker compose 檔了，但是有許多其他的設定我還沒辦法寫成很好的自動化腳本，摻雜人工的部署，不確定性就會大大提升，這部分不論是部署的設計，或是 server 架構的設計都有待加強。
